...
| Передумови:        | - Проєкт з таким іменем не створений                                                                                                                                                                                                                      |
| Результат:         | Новий проєкт                                                                                                                                                                                                                                              |
| Виключні ситуації: | Проєкт з таким іменем вже створений <font color="red">NotUniqueProjectName</font>                                                                                                                                                                         |
| Основний сценарій: | 1. Тімлід заходить в меню управління проєктами<br>2. Тімлід натискає "Створити новий проєкт"<br>3. Тімлід заповнює поля з інформацією проєкту<br>4. Натискає "Створити" (можливе NotUniqueProjectName)<br>5. Відкривається сторінка зі створеним проєктом |
...
| Виключні ситуації: | Тімлід не проходить перевірку на підтвердження вибору (Captcha) <font color="red">NotConfirmedActionException</font>                                                                                                                                                                         |
| Основний сценарій: | 1. Тімлід заходить в меню управління проєктами<br>2. Обирає меню дій над потрібним проєктом<br>3. Натискає "Видалити"<br>4. Відкривається вікно з підтвердженням вибору, тімлід виконує підтвердження (можливе NotConfirmedActionException)<br>5. Переадресація на меню управління проєктами |

| ID                 | <span id=AddMember>`AddMember`</span>                                                                                                                                                                                                                                         |
|:-------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Назва:             | Додати робітника до проєкту                                                                                                                                                                                                                                                   |
| Учасники:          | Тімлід, система                                                                                                                                                                                                                                                               |
| Передумови:        | - Цей користувач не є робітником проєкту                                                                                                                                                                                                                                      |
| Результат:         | Користувач є робітником комуністичної соціалістичної системи                                                                                                                                                                                                                  |
| Виключні ситуації: | Користувач вже є партійним діячем <font color="red">UserAlreadyProjectMemberException</font>                                                                                                                                                                                  |
| Основний сценарій: | 1. Тімлід заходить в меню управління проєктами<br>2. Обирає меню дій над потрібним проєктом<br>3. Натискає "Додати робітника"<br>4. Відкривається вікно з інформаційними полями, тімлід виконує дію (можливе UserAlreadyProjectMemberException)<br>5. Переадресація на проєкт |

| ID                 | <span id=DeleteMember>`DeleteMember`</span>                                                                                                                                                                                                                                   |
|:-------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Назва:             | Видалити робітника з проєкту                                                                                                                                                                                                                                                  |
| Учасники:          | Тімлід, система                                                                                                                                                                                                                                                               |
| Передумови:        | - Цей користувач є робітником в проєкті                                                                                                                                                                                                                                       |
| Результат:         | Користувач відправлений в Сибір                                                                                                                                                                                                                                               |
| Виключні ситуації: | Користувач не є робітником проєкту <font color="red">UserIsNotProjectMemberException</font>                                                                                                                                                                                   |
| Основний сценарій: | 1. Тімлід заходить в меню управління проєктами<br>2. Обирає меню дій над потрібним проєктом<br>3. Натискає "Видалити робітника"<br>4. Відкривається вікно з інформаційними полями, тімлід виконує дію (можливе UserIsNotProjectMemberException)<br>5. Переадресація на проєкт |
...
| Учасники:          | Тімлід, система                                                                                                                                                                                                                                                                         |
| Передумови:        | - Попередній Спрінт вже закінчився                                                                                                                                                                                                                                                      |
| Результат:         | Створений новий Спрінт                                                                                                                                                                                                                                                                  |
| Виключні ситуації: | Номер/назва Спрінта не є унікальною <font color="red">NotUniqueSpringNameException</font>                                                                                                                                                                                               |
| Основний сценарій: | 1. Тімлід заходить в меню управління проєктами<br>2. Обирає меню дій над потрібним проєктом<br>3. Натискає "Створити та почати новий Спрінт"<br>4. Відкривається вікно з інформаційними полями, тімлід виконує дію (можливе NotUniqueSpringNameException)<br>5. Переадресація на проєкт |
...
| Учасники:          | Тімлід, система                                                                                                                                                                                                                                                                   |
| Передумови:        | - Поточний Спрінт вже наближається до кінця                                                                                                                                                                                                                                       |
| Результат:         | Спрінт закінчений та знаходиться в архіві Спрінтів                                                                                                                                                                                                                                |
| Виключні ситуації: | Тімлід не проходить перевірку на підтвердження вибору (Captcha) <font color="red">NotConfirmedActionException</font>                                                                                                                                                              |
| Основний сценарій: | 1. Тімлід заходить в меню управління проєктами<br>2. Обирає меню дій над потрібним проєктом<br>3. Натискає "Закінчити Спрінт"<br>4. Відкривається вікно з підтвердженням вибору, тімлід виконує підтвердження (можливе NotConfirmedActionException)<br>5. Переадресація на проєкт |
