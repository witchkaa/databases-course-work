...
| Учасники:          | Користувач (тімлід, або розробник), система                                                                                                                                                                                                                                                                                                                                                                                                            |
| Передумови:        | - Користувач не має облікового запису в системі                                                                                                                                                                                                                                                                                                                                                                                                        |
| Результат:         | Створення облікового запису користувача (через інформацію, отриману з GitHub профілю користувача)                                                                                                                                                                                                                                                                                                                                                      |
...
| Результат:         | Створено новий Спрінт                                                                                                                                                                                                                                                                                                                                                                 |
...
| Результат:         | Розгляд повідомлення системною адміністрацією                                                                                                                                                                                                                                                                                                                                |
| Виключні ситуації: | Користувач не авторизований в системі <font color="red">UserIsNotLoggedInException</font>                                                                                                                                                                                                                                                                                    |
| Основний сценарій: | 1. Користувач натискає на "Користувацька підтримка"<br>2. Система перекидає користувача на сторінку F.A.Q. <br>3. Користувач натискає на "Звʼязатися з адміністрацією" (можливе UserIsNotLoggedInException)<br>4. Користувач пише повідомлення й надсилає його<br> 5. Система надсилає це повідомлення до профілю адміністрації <br> 6. Адміністратор розглядає повідомлення |
...
* додавати, редагувати, видаляти та коментувати завдання для команди
* створити проект
* видалити проект
* створити спринт
* завершити спринт
